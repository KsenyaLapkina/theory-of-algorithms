...
# Для списка песен
# Вычисляем время звучания трех песен: 'Halo', 'Enjoy the Silence' и 'Clean'
total_time_list = 0
...
print('Три песни звучат', total_time_list_rounded, 'минут')

# Вычисляем время звучания трех песен: 'Sweetest Perfection', 'Policy of Truth' и 'Blue Dress'
...
print('А другие три песни звучат', total_time_dict_rounded, 'минут')